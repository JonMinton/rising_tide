...
p1 / (p2 + p3) + plot_layout(guide = "collect") +
  plot_annotation(
    title = 'Changing mortality survivorship curve and lifespan disparity contributions in Japan',
    caption = 'Source: Human Mortality Database'
)
...
p1 / (p2 + p3) + plot_layout(guide = "collect") +
  plot_annotation(
    title = 'Changing mortality survivorship curve and lifespan disparity contributions in USA',
    caption = 'Source: Human Mortality Database'
)
...
```
Now let's try to produce some faceted versions of these comparing USA with Japan. 
...
p1 <- e_dagger_younger_parts %>% 
  ...
  labs(x = "Age in years", y = "Contribution to lifespan disparity in years")
p1
...
(p1 / p2) + 
  plot_annotation(
    title = 'Age-specific contributions to lifespan disparity, USA and Japan',
